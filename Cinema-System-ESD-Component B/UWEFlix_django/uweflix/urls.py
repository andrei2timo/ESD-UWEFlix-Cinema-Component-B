...
urlpatterns = [
    ...
    path("specific_club_endpoint/<int:club>/", views.specific_club_endpoint, name="specific_club_endpoint"),
    ...
    path("specific_screen_endpoint/<int:screen>/", views.specific_screen_endpoint, name="specific_screen_endpoint"),
